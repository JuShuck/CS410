...
public class Flight extends AbstractFlight {
     ...
     * @param depart        the departure time in the format of MM/dd/yyyy hh:mm
     * @param dest          the 3-Character Destination code
     * @param arrive        the arrival time in the format of MM/dd/yyyy hh:mm
     */
    public Flight(int num, String src, String depart, String dest, String arrive) {
        this.flightNum = num;
        this.source = src;
